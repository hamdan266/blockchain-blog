                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                        <div className="col-span-2">
                            ...
                            <p className="text-xl lg:text-2xl text-zinc-400 mt-8">
                                Blockforge provides robust and secure infrastrukture to support  the next genereation of decentralized applications.
                            </p>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                        ...
                        <div className="col-span-2">
                            ...
                            <div className="flex flex-col text-xl lg:text-2xl text-zinc-400 mt-6 gap-6">
                                ...
                                <p>
                                    Blockforge champtoins Web3 for everyone. As a decentralized blockchain scaling platform, Blockforge enables developers to create scalable, user-friendly dApps with low transaction costs, all while ensuring robust security.
                                </p>
                            </div>
                            <div className="flex gap-8 mt-12">
