            ...
            {totalPathLength && (
                <motion.svg
                    ...
                    style={{
                        ...
                        height: size,
                        width: size,
                        // transition: "stroke-dashoffset 2s ease-in-out infinite",
                    }}
                >
